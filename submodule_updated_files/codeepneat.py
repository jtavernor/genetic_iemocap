...
class CoDeepNEAT(BaseNeuroevolutionAlgorithm,
    ...
    def __init__(self, config, initial_state_file_path=None):
        ...
        self.avg_generation_size = []
        self.cur_gen_fitnesses = []
        self.cur_gen_sizes = []
    ...
    def evaluate_population(self, environment) -> (int, float):
        ...
        for blueprint in self.pop.blueprints.values():
            ...
            for _ in range(self.genomes_per_bp):
                ...
                try:
                    ...
                    self.cur_gen_fitnesses.append(genome_fitness)
                    self.cur_gen_sizes.append(params)
        ...
        self.avg_generation_fitness.append(np.mean(self.cur_gen_fitnesses))
        self.avg_generation_size.append(np.mean(self.cur_gen_sizes))
        self.cur_gen_fitnesses = []
        self.cur_gen_sizes = []
