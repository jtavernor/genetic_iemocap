...
import neat_pytorch_linear.utils as utils
from neat_pytorch_linear.genotype.genome import Genome
from neat_pytorch_linear.species import Species
from neat_pytorch_linear.crossover import crossover
from neat_pytorch_linear.mutation import mutate
...
class Population:
    ...
    def run(self):
        for generation in range(1, self.Config.NUMBER_OF_GENERATIONS):
            ...
            for genome in self.population:
                genome.current_generation = generation
