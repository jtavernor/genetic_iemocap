...
setup(
    ...
    packages=['neat_pytorch_linear', 'neat_pytorch_linear.phenotype', 'neat_pytorch_linear.genotype']
)
# renamed and added exported packages to allow this work without sharing the same name as the neat-python package