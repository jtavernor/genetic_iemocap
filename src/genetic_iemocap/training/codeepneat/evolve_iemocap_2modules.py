...
def codeepneat_cifar10_example(_):
    ...
    config_file_path = './iemocap_config_2modules.cfg'
    ...
    plt.savefig(f'average_fitnesses_codeepneat_2modules.png')
    ...
    plt.savefig(f'average_params_codeepneat_2modules.png')
