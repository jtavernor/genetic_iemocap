...
plt.savefig('average_fitnesses_small_2.png')
...
plt.savefig('average_params_small_2.png')
...
if solution is not None:
    ...
    print('Solution accuracy:', test_accuracy)

    draw_net(solution, view=True, filename='./images/feedforward_small_2_solution', show_disabled=True)
else:
    ...
    draw_net(best_individual, view=True, filename='./images/feedforward_small_2_best_ind', show_disabled=True)
